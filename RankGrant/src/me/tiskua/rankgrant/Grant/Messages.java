...
public class Messages {
	...
	public void sendToGranter() {
		String grantOption = GrantManager.getGrantOption();
		String messageSection = grantOption == "Rank" ? "Messages.Grant.Rank.Granter" : "Messages.Grant.Permission.Granter";
	...
	public void sendGrantStaffMessage(Player staff) {
		for(Player online : Bukkit.getOnlinePlayers()) {
			if(online.hasPermission("grant.notify") && online != staff) {
				...
				String messageSection =  GrantManager.getGrantOption() == "Rank" ? "Messages.Grant.Rank.Staff" : "Messages.Grant.Permission.Staff";
				
				for (String msg : Files.config.getStringList(messageSection)) 
					finalStaffmessage.append(Util.replaceMessageValues(msg) + "\n");					
	...
	public void sendToTarget(Player target) {
		String grantOption = GrantManager.getGrantOption();
		String messageSection = grantOption == "Rank" ? "Messages.Grant.Rank.Target" : "Messages.Grant.Permission.Target";
